...
download.file("https://www.dropbox.com/s/h5c1okn4m6t3rqe/BoundaryData.zip?dl=1" , 
              destfile="data/BoundaryData.zip",
              mode = "wb")
...
tm_shape(manchester_crime_lsoa) + 
  ...
  tm_borders(alpha = 0.1) +
  tm_layout(main.title = "Crime in Manchester City, June/2019", main.title.size = 0.7 ,
...
crime_rate_map <- tm_shape(manchester_crime_lsoa) + 
  ...
  tm_layout(panel.labels = "Crime per 100,000 population", legend.position = c("right", "bottom"),
            legend.title.size = 0.8, legend.text.size = 0.5)
