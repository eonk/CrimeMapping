...
Because the latest data of GMP is June 2019, we should download data from `Archive` tab, not `Custom download` tab. If you scroll down, you will find `June 2021` folder which contains crime data from July 2018 to June 2021. I know!!😩 it's a huge file as it has 'crime' and 'stop and search' data of all police forces from July 2018 to June 2021. You can download the folder as a practice or use the data that we already have downloaded for you. You can go back to this week’s learning materials to download from Blackboard.
